...
describe('restaurant router', () => {
  ...
  describe('GET /restaurant/:id/reservations/', () => {
    test('should return 200 response', () => {
      return request(app).get('/restaurant/300/reservations/')
        .then((response) => {
          expect(response.statusCode).toBe(200);
        });
    });

    test('should return expected object shape', () => {
      return request(app).get('/restaurant/300/reservations/')
        .then((response) => {
    ...
    test('should return expected reservation information', () => {
      return request(app).get('/restaurant/300/reservations')
        .then((response) => {
  ...
  describe('GET /restaurant/:id/reservations/2018-03-01', () => {
    test('should return 200 response', () => {
      return request(app).get('/restaurant/300/reservations/2018-03-01')
        .then((response) => {
          expect(response.statusCode).toBe(200);
        });
    });
